  ...
  const [zhukovArtist, gagarinaArtist, NoizeMCArtist] = await Artist.create(
    {
      name: "Sergei Zhukov",
      description:
        "Sergey Evgenievich Zhukov (born May 22, 1976, Dimitrovgrad, Ulyanovsk region) is a Russian singer, musician, entrepreneur, music producer, TV and radio presenter, DJ. Soloist and leader of the Russian pop group “Hands Up!”\n" +
    ...
    },
    {
      ...
      description:
        "Polina Sergeevna Gagarina (born March 27, 1987[1][2], Moscow) is a Russian pop singer, film, television, voice and dubbing actress, composer and model[3]. People's Artist of the Republic of Bashkortostan (2024)[4].\n" +
